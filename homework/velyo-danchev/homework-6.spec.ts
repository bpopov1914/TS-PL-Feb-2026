...
test('example using css/xpath  as locators', async({page}) => {
    ...
    await page.locator('li.ui-menu-item:has-text("Bulgaria")').click();
    await expect(page.locator('#autocomplete')).toHaveValue('Bulgaria');
